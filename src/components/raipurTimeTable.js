                ...
                <div className="overflow-x-auto overflow-y-auto max-h-[75vh] touch-auto">
                    <table className="table table-compact table-fixed w-full whitespace-nowrap divide-y divide-primary">
                        ...
                        <tbody className=" [&>tr>td]:border-t [&>tr>td]:border-primary">
                            ...
                            <tr className={isToday('21 Feb') ? 'ring-4 ring-success/40 bg-success/20 border-2 border-success/60 rounded-md' : ''}><td className="font-semibold">3</td><td className="text-sm">21 Feb</td><td className="text-sm">Fri</td><td className="font-medium text-success">05:16</td><td className="font-medium text-warning">06:07</td></tr>
