...
export default function ViewMasjidClient() {
    ...
    useEffect(() => {
        ...
        const fetchMasjid = async () => {
            try {
                ...
                if (!mounted) return;
                setMasjid(data?.data ? data.data : data);
            } catch (e) {
                if (!mounted) return;
    ...
    if (error) return (
        <div className="p-6">
            ...
            <div className="flex gap-2">
                ...
                <Link href="/admin/all-masjids"><button className="px-3 py-2 bg-gray-100 rounded">All Masjids</button></Link>
            </div>
        </div>
    );
        ...
        <div className="p-4 md:p-8 text-black">
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Link href={`/admin/all-masjids/edit-jamatTime?id=${m.id}`}><button className="px-3 py-2 bg-yellow-300 text-black rounded">Edit</button></Link>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <div className="font-medium">
                            {m.pasteMapUrl ? (
                                <a href={m.pasteMapUrl} target="_blank" rel="noreferrer" className="text-blue-600 underline">Open Location</a>
                            ) : (
